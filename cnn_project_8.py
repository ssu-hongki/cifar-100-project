...
BATCH_SIZE = 64
NUM_CLASSES = 100
SAVE_NAME = "Gaban3jo_0602_AdamP_Aug"
EPOCHS = 100
...
train_transform = Compose([
    ...
    AutoAugment(policy=AutoAugmentPolicy.CIFAR10),  # ✅ AutoAugment 사용
    ToTensor(),
...
# ===================== 옵티마이저 & 손실함수 =====================
optimizer = AdamP(model.parameters(), lr=1e-3, weight_decay=1e-2)
