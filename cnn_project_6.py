...
from torchvision.transforms import Compose, ToTensor, Resize, RandomHorizontalFlip, RandomCrop, Normalize, ColorJitter, RandomRotation, RandAugment
...
train_size = int(len(full_train) * 0.8)  # ✅ 80:20 split
